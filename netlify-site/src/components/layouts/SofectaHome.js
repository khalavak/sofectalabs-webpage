        ...
        <div data-sb-object-id={page.__metadata?.id}>
            ...
            <header>
                <div className="container">
                    <nav>
                        <div className="logo">
                            <img src="/assets/logo-horizontal.png" alt="SOFECTA LABS" />
                        </div>
                        <ul className="nav-links" id="navLinks">
                            ...
                            <li className="nav-mobile-only"><a href="#initiate" className="btn-sofecta">GET STARTED</a></li>
                        </ul>
            ...
            <main>
                ...
                <section className="logo-carousel">
                    <div className="logo-track">
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152d15ce60232dc5ba8419_BE_LOGO.png" alt="BE Group" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152d3db80355ee69327a34_algol-white.png" alt="Algol" /></div>
                        <div className="logo-slide"><img src="https://www.borenius.com/images/svg/logo-borenius-white.svg" alt="Borenius" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152d68a834e75376b5e3e1_mipro_logo.png" alt="Mipro" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152ded89d3b20f5bfba644_logo_mediconsult.webp" alt="Mediconsult" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152e5408a370284c306ed7_omsen_pos_opt2x.png" alt="Omsen Försäkringar" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/66152f5d9e3b40ee72f1652e_granlund.svg" alt="Granlund" /></div>
                        <div className="logo-slide"><img src="https://cdn.prod.website-files.com/65c2aa28f71f67763922a2eb/6615323ed3448754fa671552_mariehamns.png" alt="Mariehamns Energi" /></div>
